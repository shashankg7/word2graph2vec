...
class gen_graphs(object):
    ...
    def contruct_graphs(self,args):
        ...
        json.dump(self.all_words,open('word_mapping','wb'))
        json.dump(self.all_labels,open('label_mapping','wb'))
        json.dump(self.all_documents,open('document_mapping','wb'))
